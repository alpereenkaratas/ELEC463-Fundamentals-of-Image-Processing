...
class Image {
 ...
 public:
  ...
  Image negativeImage();
  Image logTransform();
  Image gammaTransform(float);
  Image meanFilter(int,int);
  int findMedian(int*, int);
  Image medianFilter(int, int);
  Image histogramEqualization();
  Image gaussianFilter(int, int);
  Image laplacianFilter(int, int);
  Image sharpenedLaplacianFilter(int, int);
  Image twoDimFourierTransform();
  Image inverseTwoDimFourierTransform();
  Image moveImageToCenter();
  Image createImageforlab3q0();
  Image sobelFilterXaxis(int, int);
  Image sobelFilterYaxis(int, int);
  Image lab4Q2filter();
  Image lab4Q2shiftedFilter();
